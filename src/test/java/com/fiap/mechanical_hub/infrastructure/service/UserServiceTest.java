...
class UserServiceTest {
    ...
    void shouldRegisterNewUser_whenEmailAndProfileAreValid() {
        RegisterRequest request = new RegisterRequest("João Silva", "joao@email.com", "senha123", "ADMINISTRATOR");
    ...
    void shouldThrowIllegalArgument_whenProfileNotFound() {
        RegisterRequest request = new RegisterRequest("João Silva", "joao@email.com", "senha123", "UNKNOWN");
        when(userRepositoryAdapter.findByEmail("joao@email.com")).thenReturn(null);
